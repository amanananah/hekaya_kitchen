...
export const recipes: Recipe[] = [
  {
    ...
    knowledge: [
      ...
      { label: 'SOUND', title: 'Listen for the softer sizzle', detail: 'Fatima lowers the heat when the oil changes from a sharp crackle.' },
    ],
    lesson: {
  ...
  },
  {
    ...
    quoteStep: 'Fatima’s phrase from Step 3',
    knowledge: [
    ...
    lesson: {
      ...
      steps: [
        ...
        { title: 'Find the closing trail', checkpoint: 'The spoon trail should stay visible for a moment, then close slowly behind you.', coach: 'The mixture still looks slightly loose. Continue folding gently before adding any more water.', familyTip: 'This is the moment Fatima calls “one soft wave.”' },
  ...
  },
  {
    ...
    year: 'Practice',
    category: 'Breakfast',
    summary: 'Grandma Fatima’s simple two-minute recipe, shared in her own voice for the family to follow.',
    duration: '2:00',
    checkpointCount: 5,
    storyCount: 0,
    confirmedSteps: 0,
    ...
    quoteStep: 'Grandma Fatima’s tip from Step 3',
    knowledge: [
